...
class ADT_Node {
 public:
  ...
  void set_node_value(int new_value); // used in Dijkstra's algorithm
  ADT_Node<T>* get_prev_node(void); // used in Dijkstra's algorithm
  void set_prev_node(ADT_Node<T>* new_prev_node); // used in Dijkstra's algorithm
  set<string>* get_set_ptr(void); // used in Kruskal's algorithm
  void set_set_ptr(set<string>* new_set_ptr); // used in Kruskal's algorithm
 ...
 private:
  ...
  ADT_Node<T>* prev_node; // stores the ptr to previous node, used in Dijkstra's algorithm
  set<string>* set_ptr; // ptr to set, used in Kruskal's algorithm
};
