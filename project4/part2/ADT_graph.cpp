...
/* Set node value */
template <class T>
void ADT_Node<T>::set_node_value(int new_value) {
  node_value = new_value;
}

/* Get previous node pointer*/
template <class T>
ADT_Node<T>* ADT_Node<T>::get_prev_node(void) {
  return prev_node;
}

/* Set new previous node pointer */
template <class T>
void ADT_Node<T>::set_prev_node(ADT_Node<T>* new_prev_node) {
  prev_node = new_prev_node;
}

/* Get pointer to set */
template <class T>
set<string>* ADT_Node<T>::get_set_ptr(void) {
  return set_ptr;
}

/* Set pointer to set */
template <class T>
void ADT_Node<T>::set_set_ptr(set<string>* new_set_ptr) {
  set_ptr = new_set_ptr;
}
